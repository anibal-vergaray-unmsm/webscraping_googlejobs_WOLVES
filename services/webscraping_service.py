...
class WebScrapingService():
    ...
    def scrape(self, url_pagina, numero_paginas, id_webscraping):
        ...
        for x in range(0, numero_paginas):
            #Se baja el scroll hasta el final
        ...
        for oferta in ofertas:
            ...
            # Mpstrar más detalle con respecto a cada oferta
            try:
            ...
            if (oferta_service.OfertaService().existe_registro(id_anuncioempleo)):
                ...
                if not (("hora" in tiempo_publicado) or ("día" in tiempo_publicado) or ("mes" in tiempo_publicado)):
                    tiempo_publicado = None
